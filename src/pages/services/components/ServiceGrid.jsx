...
const ServiceGrid = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "El centro digital de tu empresa: credibilidad, autoridad y confianza en un sitio web hecho 100% a la medida en código puro.",
      icon: "Building2",
      features: [
    ...
    },
    {
      ...
      description:
        "Aplicaciones web únicas y escalables que resuelven retos específicos de negocio y aceleran tu crecimiento.",
      icon: "Code2",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            Cada servicio está diseñado para resolver desafíos específicos de negocio con métricas medibles y ROI
            comprobado.
          </p>
        </div>
