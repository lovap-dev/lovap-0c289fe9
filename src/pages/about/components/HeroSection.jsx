...
const HeroSection = () => {
  return (
    <section className="relative border-b border-border/30 bg-gradient-to-br from-background via-primary/[0.07] to-muted/35 pt-24 pb-16 lg:pt-32 lg:pb-24">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center space-x-2 bg-gray-200 text-secondary px-4 py-2 rounded-full text-sm font-inter font-medium mb-6">
